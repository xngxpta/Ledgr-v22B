...
with st.container(border=True):
    ...
    if choix1 == "Moving Averages (MA)":
        ...
        st.info("""The MACD Diff Plot indicates that refers to the difference or divergence between moving averages, which is the core calculation of the MACD indicator.
